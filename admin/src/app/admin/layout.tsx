...
const NAV = [
  { href: "/admin", label: "Dashboard", roles: ["OWNER", "ADMIN"] },
  ...
  { href: "/admin/payments", label: "Payments", roles: ["OWNER", "ADMIN"] },
  { href: "/admin/payouts", label: "Payouts", roles: ["OWNER", "ADMIN"] },
  { href: "/admin/my-earnings", label: "My earnings", roles: ["TRAINER"] },
  { href: "/admin/availability", label: "My availability", roles: ["TRAINER"] },
