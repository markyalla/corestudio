// Country dial codes for phone inputs in the mobile app. Ghana first — it's
// the default selection since the studio is Accra-based. Kept in sync by
// hand with admin/src/lib/phone.ts (separate apps, no shared package).
